...
export default function Skills() {
  return (
    <div className="container mx-auto" id="skills">
      ...
      <div className="mx-2 flex flex-col rounded-xl bg-gradient-to-b from-zinc-900 to-zinc-950 px-4 lg:px-20">
        {SKILLS.map((skill, index) => (
          <div key={index} className="mb-8 flex items-center justify-between pt-4">
